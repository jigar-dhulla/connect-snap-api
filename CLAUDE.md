...
ConnectSnap API - Backend platform for a networking app where event attendees can register, create profiles with auto-generated QR codes, scan other attendees' QR codes to save connections, and add private notes.
...
Profile:     GET/PUT /api/profile, POST /api/profile/photo, GET /api/profile/qr-code
Connections: POST /api/connections/scan, GET /api/connections, GET/PUT/DELETE /api/connections/{id}
Public:      GET /api/u/{qr_hash}  (no auth)
```
